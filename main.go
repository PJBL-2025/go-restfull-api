...
func main() {
	...
	app.Use(cors.New(cors.Config{
		AllowOrigins:     "http://localhost:5500, http://127.0.0.1:5500,http://localhost:4000, http://127.0.0.1:4000, http://localhost:5173, http://localhost:8000, http://127.0.0.1:8000",
